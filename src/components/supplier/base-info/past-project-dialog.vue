<template>
  <el-dialog
    title="项目信息(过往合作项目情况)"
    :visible.sync="dialogPastProjectVisible"
    class="dialog-md"
  >
    ...
    <span slot="footer" class="dialog-footer">
      <el-button size="small" @click="dialogPastProjectVisible = false">取 消</el-button>
      <el-button type="primary" size="small" @click="dialogPastProjectVisible = false">确 定</el-button>
    </span>
  </el-dialog>
</template>
...
<script>
export default {
  name: 'PastProjectDialog',
  props: {
    dialogPastProjectVisible: {
      type: Boolean,
      default: () => false
    },
    pageForm: {
