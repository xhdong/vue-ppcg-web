<template>
  <el-form ref="ruleForm" :rules="rules" :model="ruleForm">
    ...
    <el-form-item label="确认密码" prop="confirmPass">
      <el-input v-model="ruleForm.confirmPass" type="password" placeholder="请输入确认密码" />
    </el-form-item>
    ...
    <el-form-item label="公司网址" prop="web">
      <el-input v-model="ruleForm.web" placeholder="请输入公司网址" />
    </el-form-item>
    <el-form-item label="总经理电话" prop="managerT">
      <el-input v-model="ruleForm.managerT" placeholder="请输入总经理电话" />
    </el-form-item>
    <el-form-item label="公司注册资金" prop="registeredFunds">
      <el-input v-model="ruleForm.registeredFunds" placeholder="请输入公司注册资金" />
    </el-form-item>
    ...
    <el-form-item label="详细地址" prop="detailedAddress">
      <el-input v-model="ruleForm.detailedAddress" placeholder="请输入详细地址" />
    </el-form-item>
    <el-form-item label="公司电话" prop="companyTel">
      <el-input v-model="ruleForm.companyTel" placeholder="请输入公司电话" />
    </el-form-item>
    <el-form-item label="总经理姓名" prop="managerName">
      <el-input v-model="ruleForm.officePhone" placeholder="请输入总经理姓名" />
    </el-form-item>
